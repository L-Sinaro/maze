...
void play_with_texture_4(SDL_Texture* my_texture,
  ...
  for (int cpt = 0; cpt < nb_images_animation ; ++cpt) {
    setBackground(bg_texture,         // identique à play_with_texture_1, où on a enlevé l'affichage et la pause
                          window, renderer); 
...
int main(int argc, char **argv)
{
    ...
    SDL_Texture * backgroudTexture;
    backgroudTexture = loadTextureFromImage("img/nasa-xFO2Xt33xgI-unsplash.jpg", window, renderer);

    // play_with_texture_1(backgroudTexture, window,renderer);
    // play_with_texture_2(backgroudTexture, window,renderer);
    // play_with_texture_3(backgroudTexture, window,renderer);

    SDL_Texture * sprite;
    sprite = loadTextureFromImage("img/ramonaflowers.png", window, renderer);
    // play_with_texture_1(sprite, window,renderer);
    // play_with_texture_4(sprite, window,renderer);
    // play_with_texture_5();

    SDL_Texture * spriteMonster;
    spriteMonster = loadTextureFromImage("img/shadow-80x70.png", window, renderer);

    // play_with_texture_1(spriteMonster, window,renderer);
    play_with_texture_5(backgroudTexture, spriteMonster, window,renderer);
